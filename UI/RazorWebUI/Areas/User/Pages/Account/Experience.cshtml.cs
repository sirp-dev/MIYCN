...
namespace RazorWebUI.Areas.User.Pages.Account
{
    public class ExperienceModel : PageModel
    {
        ...
        public ExperienceModel(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            ProfileCategories = ProfileCategories.Where(x => x.Title.ToUpper().Contains("EXPERIENCE")).ToList();
        ...
        public async Task<IActionResult> OnPostCategoriesAsync()
        {
            try
            {
                ...
                {
                    return RedirectToPage("./Experience", new { id = updatuser.Id });
